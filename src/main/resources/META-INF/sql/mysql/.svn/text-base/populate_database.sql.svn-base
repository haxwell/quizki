...
INSERT INTO topic(text) values('History');
...
INSERT INTO question(description, text, difficulty_id, type_id, user_id) values('France', '<p>Napolean was French.</p>', 1, 1, 1);
-------
INSERT INTO choice(text, iscorrect, sequence) values('True', 1, 0);
INSERT INTO choice(text, iscorrect, sequence) values('False', 0, 0);

INSERT INTO question_choice(question_id, choice_id) values(2,3);
INSERT INTO question_choice(question_id, choice_id) values(2,4);

INSERT INTO question_topic(question_id, topic_id)   values(2,3);
